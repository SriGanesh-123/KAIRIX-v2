...
question = "Trace the data flow from COBOL rating to KPI reporting."
print("=" * 80)
print(f"LINEAGE QUERY: {question}")
print("=" * 80)
...
print("\n" + "=" * 80)
print("PHASE 4: FINAL SYNTHESIZED LINEAGE TRACE")
print("=" * 80)
print(f"Confidence Score: {result.confidence * 100:.1f}%")
print(f"Source Files Involved: {result.source_files}")
print("\nTRACE PATH LOGS:")
for t in result.trace_path:
    print(f"  > {t}")
